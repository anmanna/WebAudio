const timeMargin = 700; // Within this margin the time value is considered correct
const positionMargin = 30; // Within this margin the coordinates is considered correct
const ratioMargin = 0.45; // The percentage of data points that can be wrong
